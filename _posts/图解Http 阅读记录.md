...
1. 应用层 决定了向用户提供应用服务时的通信的活动. http 协议处于该层.

2. 传输层 为上层应用层提供了处于网络连接中的两台计算机之前的数据传输. TCP 协议以及 UDP 协议.

3. 网络层 处理在网络上流动的数据包. 改成规定了通过怎样的路径(传输路线)到达对方计算机, 并将数据包传输给对方.

4. 链路层  硬件相关, 例如设备驱动、网卡、光纤等.

### TCP/IP 通信传输流

![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-1.png)

### 与 Http 密切相关的协议: IP、TCP 以及 DNS

![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-2.png)
...
![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-3.png)
...
![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-4.png)
...
![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-5.png)
...
Cookie 会根据从服务端发送的响应报文内的一个名为 `Set-Cookie` 的首部字段信息, 通知客户端保存 Cookie. 当下次客户端再往该服务发送请求时, 客户端会自动在请求报文中加入 Cookie 值后发送出去. 服务端发现客户端发送过来的 Cookie 后, 回去检查究竟是从哪一个客户端发来的连接请求, 然后对比服务器上的记录, 最后得到之前的状态信息.

![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-6.png)
...
![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-7.png)
...
![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-8.png)

![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-9.png)
...
客户端使用 HTTP 协议访问服务器时, 会经常采用类似 `www.hackkr.jp` 这样的主机名和域名.
...
![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-10.png)
...
![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-11.png)
...
![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-12.png)
...
![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-13.png)
...
![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-14.png)
...
![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-15.png)
...
![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-16.png)
...
![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-17.png)
...
2. 查明对手的证书
   ...
   ![alt](/assets/%E5%9B%BE%E8%A7%A3http/example-18.png)
